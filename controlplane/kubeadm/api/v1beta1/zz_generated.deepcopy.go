...
func (in *ExternalUpdate) DeepCopyInto(out *ExternalUpdate) {
	*out = *in
	if in.FallbackRolling != nil {
		in, out := &in.FallbackRolling, &out.FallbackRolling
		*out = new(RollingUpdate)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalUpdate.
func (in *ExternalUpdate) DeepCopy() *ExternalUpdate {
	if in == nil {
		return nil
	}
	out := new(ExternalUpdate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RolloutStrategy) DeepCopyInto(out *RolloutStrategy) {
	*out = *in
	...
	if in.ExternalUpdate != nil {
		in, out := &in.ExternalUpdate, &out.ExternalUpdate
		*out = new(ExternalUpdate)
		(*in).DeepCopyInto(*out)
	}
}
