...
import (
	...
	apiv1beta1 "sigs.k8s.io/cluster-api/controlplane/kubeadm/api/v1beta1"
)
...
func (in *BeforeControlPlaneUpgradeRequest) DeepCopyInto(out *BeforeControlPlaneUpgradeRequest) {
	*out = *in
	...
	if in.Cluster != nil {
		...
		*out = new(v1beta1.Cluster)
		(*in).DeepCopyInto(*out)
	}
	if in.KCP != nil {
		in, out := &in.KCP, &out.KCP
		*out = new(apiv1beta1.KubeadmControlPlane)
		(*in).DeepCopyInto(*out)
	}
	out.MachinesToBeUpgraded = in.MachinesToBeUpgraded.DeepCopy()
}
